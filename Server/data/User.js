...
export async function registerPersonAndUser(personData) {
    console.log("Datos de Persona",personData)
    ...
    try {
        ...
        const userData = { userName: generateUserName(personData.nit, personData.name, personData.lastName ), password: hashedPassword, role: personData.role  };
...
export async function updateUsuarioById(id, userData) {
    ...
    try {
        ...
        // Actualiza el role en la tabla "user"
        await connection.query(
